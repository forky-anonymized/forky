...
void CoinsViews::InitCache()
{
    ...
    // Forky: for fuzzing!
    m_cacheview_fuzz = std::make_unique<CCoinsViewCache>(&m_catcherview);
}
...
bool ChainstateManager::FuzzProcessNewBlock(BlockValidationState& state, const std::shared_ptr<const CBlock>& block, bool force_processing, bool min_pow_checked, bool* new_block)
{
    AssertLockNotHeld(cs_main);
